# ASP.NET MVC Grid with SQL Server Connectivity using Dapper and UrlAdaptor

This project demonstrates how to bind data and handle CRUD operations in the **Syncfusion EJ2 Grid** using **Dapper ORM** and the **UrlAdaptor** in an **ASP.NET MVC** application.

# ASP.NET MVC Grid with SQL Server Connectivity using Microsoft SQL Server and CustomAdaptor

This project demonstrates how to bind data and handle CRUD operations in the **Syncfusion EJ2 Grid** using **Microsoft SQL Server** and the **CustomAdaptor** in an **ASP.NET MVC** application.

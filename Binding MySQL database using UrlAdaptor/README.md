# ASP.NET MVC Grid with SQL Server Connectivity using MySQL Server and UrlAdaptor

This project demonstrates how to bind data and handle CRUD operations in the **Syncfusion EJ2 Grid** using **MySQL Server** and the **UrlAdaptor** in an **ASP.NET MVC** application.

# ASP.NET MVC Grid with SQLite Server and CustomAdaptor

This project demonstrates how to bind data and handle CRUD operations in the **Syncfusion EJ2 Grid** using **SQLite Server** and the **CustomAdaptor** in an **ASP.NET MVC** application.
